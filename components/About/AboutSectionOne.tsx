  ...
  return (
    ...
    >
      <div className="w-full px-4 sm:px-6 lg:px-12 mx-auto relative">
        ...
        >
          {/* Text Content */}
          <div className="w-full lg:w-8/12 max-w-[850px] text-left bg-slate-300 p-4 sm:p-6 rounded-lg">
            <div className="space-y-4 sm:space-y-6 text-[18px] sm:text-[20px] md:text-[22px] leading-relaxed text-justify font-normal text-dark-green font-serif">
              <h1 className="text-4xl sm:text-5xl font-extrabold mb-4 text-dark font-serif">About Me</h1>
              <p>
